import svgPaths from "./svg-vt0zc62js9";
...
import imgImage16 from "figma:asset/16efc1e42ad79e08a37c6e9782b6fae05ff133fa.png";
...
import imgImage17 from "figma:asset/87132da5e0764cdee84f42a243756e685a6cc805.png";
  ...
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Container">
      ...
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#d20761] text-[12px] whitespace-nowrap">
        <p className="leading-[20px]">IMPLANTIUM</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0" data-name="Heading 2">
      <div className="flex flex-col font-['Montserrat:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[64px] text-center text-white whitespace-nowrap">
        <p className="leading-[72px]">Implatium</p>
      </div>
    </div>
  );
}
...
function Desktop4() {
  return (
    <div className="bg-black h-[752px] overflow-clip relative shrink-0 w-[1440px]" data-name="Desktop - 124">
      <div className="absolute h-[622px] left-0 top-[226px] w-[1440px]" data-name="Group 38167 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full opacity-15 md:opacity-20 mix-blend-screen" src={imgGroup381671} />
      </div>
      <Container65 />
...
function Overlay14() {
  return (
    <div className="bg-[#d3e2f5] content-stretch flex gap-[8px] items-center px-[16px] py-[8px] relative rounded-[9999px] shrink-0" data-name="Overlay">
      <Svg22 />
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#344ecc] text-[14px] text-center whitespace-nowrap">
        <p className="leading-[20px]">CLINICAL DOCUMENTATION</p>
      </div>
    </div>
  );
}
...
function Heading14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 2">
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#070707] text-[48px] text-center w-full">
        <p className="leading-[48px] whitespace-pre-wrap">Clinical Case</p>
      </div>
    </div>
  );
}
...
function PreOperative() {
  return (
    <div className="h-[224px] relative shrink-0 w-full" data-name="Pre-operative">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgPreOperative} />
    </div>
  );
}
...
function Container84() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white tracking-[0.6px] uppercase whitespace-nowrap">
...
function Container85() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-white w-full">
        <p className="leading-[24px] whitespace-pre-wrap">Pre-operative</p>
      </div>
    </div>
  );
}
...
function Container82() {
  return (
    <div className="absolute bottom-0 content-stretch flex flex-col gap-[4px] items-start left-0 p-[16px] right-0" data-name="Container">
      <Container83 />
      <Container85 />
    </div>
  );
...
function Container81() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[16px] shrink-0 w-[433.33px]" data-name="Container">
      <PreOperative />
...
function ImplantPlacement() {
  return (
    <div className="h-[224px] relative shrink-0 w-full" data-name="Implant Placement">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImplantPlacement} />
    </div>
  );
}
...
function Container90() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-white w-full">
        <p className="leading-[24px] whitespace-pre-wrap">Superline / Implantium</p>
      </div>
    </div>
  );
}
...
function HealingAbutment() {
  return (
    <div className="h-[224px] relative shrink-0 w-full" data-name="Healing Abutment">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgHealingAbutment} />
    </div>
  );
}
...
function Container94() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white tracking-[0.6px] uppercase whitespace-nowrap">
        <p className="leading-[16px]">Step 3</p>
      </div>
    </div>
  );
}
...
function Container95() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-white w-full">
        <p className="leading-[24px] whitespace-pre-wrap">Grafting Material</p>
      </div>
    </div>
  );
}
...
function Container91() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[16px] shrink-0 w-[433.34px]" data-name="Container">
      <HealingAbutment />
      <div className="absolute bg-gradient-to-t from-[rgba(0,0,0,0.8)] inset-0 to-[rgba(0,0,0,0)] via-1/2 via-[rgba(0,0,0,0.2)]" data-name="Gradient" />
      <Container92 />
    </div>
...
function FinalRestoration() {
  return (
    <div className="h-[224px] overflow-clip relative shrink-0 w-full" data-name="Final Restoration">
      <div className="absolute h-[287px] left-0 top-[-31.4px] w-[433px]" data-name="image 17">
...
function Container99() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white tracking-[0.6px] uppercase whitespace-nowrap">
        <p className="leading-[16px]">Step 4</p>
      </div>
    </div>
  );
}
...
function Container100() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-white w-full">
        <p className="leading-[24px] whitespace-pre-wrap">Healing 2 Weeks</p>
      </div>
    </div>
  );
}
...
function Component6MonthFollowUp() {
  return (
    <div className="h-[224px] relative shrink-0 w-full" data-name="6 Month Follow-up">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img6MonthFollowUp} />
    </div>
  );
}
...
function Container104() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white tracking-[0.6px] uppercase whitespace-nowrap">
        <p className="leading-[16px]">Step 5</p>
      </div>
    </div>
  );
}
...
function Container105() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-white w-full">
        <p className="leading-[24px] whitespace-pre-wrap">Healing 4 months / Second state surgery</p>
      </div>
    </div>
  );
}
...
function Component1YearFollowUp() {
  return (
    <div className="h-[224px] relative shrink-0 w-full" data-name="1 Year Follow-up">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={img1YearFollowUp} />
    </div>
  );
}
...
function Container109() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white tracking-[0.6px] uppercase whitespace-nowrap">
        <p className="leading-[16px]">Step 6</p>
      </div>
    </div>
  );
}
...
function Container110() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-white w-full">
        <p className="leading-[24px] whitespace-pre-wrap">Final Prosthesis</p>
      </div>
    </div>
  );
}
...
function Container80() {
  return (
    <div className="content-start flex flex-wrap gap-[24px_20px] items-start relative shrink-0 w-full" data-name="Container">
      <Container81 />
      <Container86 />
      <Container91 />
      <Container96 />
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <Heading14 />
      <div className="flex flex-col font-['Arial:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b7280] text-[20px] text-center w-full">
        <p className="leading-[32.5px] whitespace-pre-wrap">Real-world clinical documentation demonstrating the Implantium system in action.</p>
      </div>
      <Container80 />
    </div>
  );
...
function Section2() {
  return (
    <div className="content-stretch flex flex-col items-start overflow-clip px-[50px] py-[80px] relative shrink-0 w-[1440px]" data-name="Section" style={{ backgroundImage: "linear-gradient(150.311deg, rgb(227, 240, 250) 0%, rgb(255, 255, 255) 100%)" }}>
      <Container78 />
    </div>
  );
}

export default function Implantium() {
  return (
    <div className="bg-white content-stretch flex flex-col items-end relative size-full" data-name="IMPLANTIUM">
      <Desktop />
      <Desktop1 />
      <Desktop2 />
      <Desktop3 />
