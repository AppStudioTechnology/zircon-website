import svgPaths from "./svg-rmbm0jrhey";
...
import imgGradient from "figma:asset/55e35189677f634cf36bbb9d0907db19d95db22f.png";
import imgPortraitBusinessPersonWork2 from "figma:asset/481a7834bff186e4fc664707ce8196d3277e158b.png";
import imgPortraitBusinessPersonWork3 from "figma:asset/d3469ad87a27105aa3ba47bc44305c5bfcb380f3.png";
  ...
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Heading 2">
      <div className="flex flex-col font-['Montserrat:SemiBold',sans-serif] justify-center leading-[72px] not-italic relative shrink-0 text-[64px] text-center text-white whitespace-nowrap">
        <p className="mb-0">Advance Your</p>
  ...
  return (
    <div className="content-stretch flex flex-col items-center max-w-[768px] pt-[8px] relative shrink-0 w-[768px]" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[32.5px] not-italic relative shrink-0 text-[20px] text-center text-white whitespace-nowrap">
        <p className="mb-0">Access world-class courses, clinical case studies, webinars, and</p>
        <p>comprehensive resources to elevate your practice.</p>
      </div>
    </div>
  );
}
...
function Desktop2() {
  return (
    <div className="bg-white h-[574px] overflow-clip relative shrink-0 w-full" data-name="Desktop - 124">
      <Frame16 />
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="bg-gradient-to-r content-stretch flex from-[#dd005c] h-[32px] items-center justify-center px-[24px] py-[4px] relative rounded-[56px] shrink-0 to-[#0088b3]">
      <p className="font-['Montserrat:SemiBold',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-white"># 24/7 Response Guarantee</p>
    </div>
  );
}
...
function Frame43() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center relative shrink-0 w-full">
      <Frame4 />
      <p className="font-['Montserrat:SemiBold',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#070707] text-[48px] text-center w-[min-content] whitespace-pre-wrap">Professional Courses</p>
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-center justify-center relative shrink-0 w-full">
      <Frame43 />
      <p className="font-['Montserrat:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#070707] text-[14px] w-[448px] whitespace-pre-wrap">Structured learning programs designed by industry experts</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          ...
          <path d="M8 4V8L10.6667 9.33333" id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Container6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#555] text-[12px] whitespace-nowrap">
        <p className="leading-[20px]">8 weeks</p>
      </div>
    </div>
  );
}
...
function Svg1() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d="M8 4.66667V14" id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p8c8fb00} id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#555] text-[12px] whitespace-nowrap">
        <p className="leading-[20px]">12 Modules</p>
      </div>
    </div>
  );
}
...
function Svg2() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d={svgPaths.p144f51c0} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p1e94b080} id="Vector_2" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
...
function Container10() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#555] text-[12px] whitespace-nowrap">
        <p className="leading-[20px]">Online + Hands-on</p>
      </div>
    </div>
  );
}
...
function Container12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#555] text-[12px] whitespace-nowrap">
        <p className="leading-[20px]">450 Students</p>
      </div>
    </div>
  );
}
      ...
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 283 1">
            <line id="Line 1" stroke="var(--stroke-0, #EBEBEB)" x2="283" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
      <p className="font-['Montserrat:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#070707] text-[20px] w-full whitespace-pre-wrap">Digital Workflow Mastery</p>
      <div className="font-['Montserrat:Regular',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#070707] text-[12px] w-full whitespace-pre-wrap">
        <p className="mb-0">Complete digital dentistry workflow from</p>
        <p>intraoral scanning to final restoration delivery.</p>
      </div>
      <Container4 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Group">
          <g id="Group_2">
            <path d="M19 12H5" id="Path" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d="M14 17L19 12" id="Path_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            <path d="M14 7L19 12" id="Path_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </g>
          <g id="Path_4" />
        </g>
      </svg>
...
function ArrowsDiagramsArrow() {
  return (
    <div className="bg-black content-stretch flex items-center p-[8px] relative rounded-[40px] shrink-0" data-name="Arrows, Diagrams/Arrow">
      <Group />
    </div>
  );
}
  ...
  return (
    <div className="relative rounded-[48px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[24px] pr-[4px] py-[4px] relative w-full">
          <p className="font-['Montserrat:Medium',sans-serif] leading-[26px] not-italic relative shrink-0 text-[18px] text-black">Enroll Now</p>
          <ArrowsDiagramsArrow />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[24px]">
      <div className="content-stretch flex flex-col gap-[16px] items-start p-[20px] relative w-full">
        <div className="h-[192px] relative rounded-[8px] shrink-0 w-full" data-name="Gradient">
          <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[8px]">
            <div className="absolute bg-black inset-0 rounded-[8px]" />
            <img alt="" className="absolute max-w-none object-cover rounded-[8px] size-full" src={imgGradient} />
          </div>
        </div>
        <Frame17 />
        <Frame10 />
...
function Desktop() {
  return (
    <div className="bg-[#f5f5f5] relative rounded-[24px] shrink-0 w-full" data-name="Desktop - 116">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[50px] py-[80px] relative w-full">
          <Frame37 />
        </div>
      </div>
    </div>
...
function Frame23() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-center justify-center not-italic relative shrink-0 text-white w-full">
      <p className="font-['Montserrat:SemiBold',sans-serif] leading-[56px] min-w-full relative shrink-0 text-[48px] text-center w-[min-content] whitespace-pre-wrap">Clinical Case Studies</p>
      <p className="font-['Montserrat:Regular',sans-serif] leading-[20px] relative shrink-0 text-[14px]">Real-world cases demonstrating clinical excellence</p>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#323231] text-[14px] whitespace-nowrap">
        <p className="leading-[20px]">Dr. James Wilson</p>
      </div>
    </div>
  );
}
...
function Container42() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#323231] text-[14px] whitespace-nowrap">
        <p className="leading-[20px]">January 2024</p>
      </div>
    </div>
  );
}
...
function Svg16() {
  return (
    <div className="relative shrink-0 size-[16px]" data-name="SVG">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="SVG">
          <path d="M8 10V2" id="Vector" stroke="var(--stroke-0, #323231)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p23ad1400} id="Vector_2" stroke="var(--stroke-0, #323231)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          <path d={svgPaths.p19411800} id="Vector_3" stroke="var(--stroke-0, #323231)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center relative">
        <Svg16 />
        <div className="flex flex-col font-['Montserrat:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#323231] text-[14px] whitespace-nowrap">
          <p className="leading-[20px]">1240 downloads</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="absolute inset-[8.33%_16.67%]" data-name="Vector">
        <div className="absolute inset-[-5%_-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 14.6667">
            <path d={svgPaths.p6ae9d40} id="Vector" stroke="var(--stroke-0, #323231)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[8.33%_16.67%_66.67%_58.33%]" data-name="Vector">
        <div className="absolute inset-[-16.67%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.33333 5.33333">
            <path d={svgPaths.p91474e0} id="Vector" stroke="var(--stroke-0, #323231)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[37.5%_58.33%_62.5%_33.33%]" data-name="Vector">
        <div className="absolute inset-[-0.67px_-50%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.66667 1.33333">
            <path d="M2 0.666667H0.666667" id="Vector" stroke="var(--stroke-0, #323231)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-[54.17%_33.33%_45.83%_33.33%]" data-name="Vector">
        <div className="absolute inset-[-0.67px_-12.5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.66667 1.33333">
            <path d="M6 0.666667H0.666667" id="Vector" stroke="var(--stroke-0, #323231)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
          </svg>
        </div>
      </div>
  ...
  return (
    <div className="relative rounded-[9999px] shrink-0" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[16px] py-[8px] relative">
        <SvgMargin />
        <div className="flex flex-col font-['Montserrat:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#323231] text-[14px] text-center whitespace-nowrap">
          <p className="leading-[20px]">View PDF</p>
        </div>
      </div>
    </div>
  );
...
function Frame24() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0 w-full">
      <p className="font-['Montserrat:Medium',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#070707] text-[22px] w-full whitespace-pre-wrap">Complex Sinus Augmentation Case</p>
      <Frame44 />
    </div>
  );
}
...
function Frame34() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[24px]">
      <div className="content-stretch flex flex-col gap-[32px] items-start p-[14px] relative w-full">
        <div className="h-[257px] relative rounded-[24px] shrink-0 w-full" data-name="portrait-business-person-work 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[24px] size-full" src={imgPortraitBusinessPersonWork2} />
        </div>
        <Frame25 />
      </div>
    </div>
...
function Frame31() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0 w-full">
      <p className="font-['Montserrat:Medium',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#070707] text-[22px] w-full whitespace-pre-wrap">Digital Smile Design Workflow</p>
      <Frame46 />
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[24px]">
      <div className="content-stretch flex flex-col gap-[32px] items-start p-[14px] relative w-full">
        <div className="h-[257px] relative rounded-[24px] shrink-0 w-full" data-name="portrait-business-person-work 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[24px] size-full" src={imgPortraitBusinessPersonWork3} />
        </div>
        <Frame30 />
      </div>
    </div>
...
function Frame29() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[60px] items-start left-[50px] top-[65px] w-[1340px]">
      <Frame23 />
      <Frame28 />
    </div>
  );
...
function Desktop1() {
  return (
    <div className="bg-black h-[751px] overflow-clip relative shrink-0 w-[1440px]" data-name="Desktop - 121">
      <Frame29 />
    </div>
  );
}
...
export default function Education() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Education">
      <Desktop2 />
      <Desktop />
      <Frame41 />
    </div>
